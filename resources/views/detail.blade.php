	...
	<header class="sticky" id="header">
		<section class="container">
			<section class="row" id="logo_menu">
				<section class="col-xs-6"><a class="logo" href="">詳細画面</a></section>
		...
		<section class="container">
			...
			<section class="row">
				...
				<div class="col-md-6 hidden-xs hidden-sm">
					...
					<img class="iphone-hand img_res wow animated bounceInUp" data-wow-duration="1.2s" src="{{{ asset ('/img/iphone_hand.png') }}}"></img>
			...
			<section class="row">
				...
				<div class="col-sm-6 col-md-4">
					<div class="feature-box wow animated flipInX" data-wow-delay="0.6s">
						...
						<h2>レンタル日：</h2>
						<p><h3><?= $rental_day ?></h3></p>
					</div>
				</div>

        <a href="line://msg/text/">LINEへ戻る</a>
<!--
				<div class="col-sm-6 col-md-4">
					<div class="feature-box wow animated flipInX" data-wow-delay="0.6s">
			...
			<section class="row">
				<div class="col-xs-12">
					<div id="screenshots" class="owl-carousel owl-theme">
					  <div class="item"><img src="{{{ asset('/img/screenshot-1.png') }}}" class="img_res wow animated zoomIn"></div>
					  <div class="item"><img src="{{{ asset('/img/screenshot-2.png') }}}" class="img_res wow animated zoomIn"></div>
					  <div class="item"><img src="{{{ asset('/img/screenshot-1.png') }}}" class="img_res wow animated zoomIn"></div>
					  <div class="item"><img src="{{{ asset('/img/screenshot-1.png') }}}" class="img_res wow animated zoomIn"></div>
					  <div class="item"><img src="{{{ asset('/img/screenshot-1.png') }}}" class="img_res wow animated zoomIn"></div>
					  <div class="item"><img src="{{{ asset('/img/screenshot-1.png') }}}" class="img_res wow animated zoomIn"></div>
			...
			<section class="row">
				<section class="col-md-3 col-sm-6">
					<div class="team-member wow animated fadeIn" data-wow-delay=="0.3s">
						<img src="{{{ asset('/img/dev-1.jpg') }}}" class="img_res team-pic">
						...
						<div class="item">
							<div class="row">
								<div class="col-sm-4 col-sm-offset-1">
									<div class="client-pic"><img class="img_res" src="{{{ asset('/img/client-one.png') }}}"></div>
									<p class="review-star">
				...
				<section class="row">
					<div class="col-sm-6">
						...
						<h1 class="footer-logo">
							Laravel5 Framework v5.10.2
						</h1>
					</div>
					<div class="col-sm-6">
						<p class="copyright">All Copyright Reserved 2016</p>
					</div>
				</section>
			</section>
		</section>
